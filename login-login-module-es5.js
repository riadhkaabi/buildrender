(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    /***/
    function srcAppEntitiesRoleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _Entities_Role__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../Entities/Role */
      "./src/app/Entities/Role.ts");
      /* harmony import */
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, router, userService, afAuth, afs, loadingController, alertController, chatService, deeplink) {
        ...
        _createClass(LoginPage, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      if (this.form.valid) {
                        this.authService.authenticate(this.form.controls.username.value, this.form.controls.password.value).subscribe(function (data) {
                          localStorage.setItem('token', data.token);

                          _this.userService.details(_this.form.controls.username.value).subscribe(function (user) {
                            localStorage.setItem('user', JSON.stringify(user));
                            _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].details = user;
                            _this.email = _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].details.email;
                            _this.currentUser = _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].details;
                            ...
                            if (_Settings_AppSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].details.authorities.includes(_Entities_Role__WEBPACK_IMPORTED_MODULE_7__["Role"].Admin)) {
                              ...
                              _this.router.navigate(['/options/home/dashboard']);
                            } else {
                              console.log('user connected');
                              console.log('connected user email' + _this.email);

                              _this.router.navigate(['/options/profile']);
                            }
                          });
                        }, function (error) {
          ...
          key: "signInToFirebase",
          value: function signInToFirebase() {
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 5:
                      ...
                      this.chatService.signIn(this.email, this.form.controls.password.value).then(function (res) {
                        loading.dismiss();
                      }, function (err) {
