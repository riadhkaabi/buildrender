...
const routes = [
    {
        path: '', component: _home_page__WEBPACK_IMPORTED_MODULE_4__["HomePage"],
        children: [
            { path: '', loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~dashboard-dashboard-module~profile-profile-module~qrattendance-qrattendance-module"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ../dashboard/dashboard.module */ "./src/app/dashboard/dashboard.module.ts")).then(m => m.DashboardPageModule), canActivate: [_Services_authguard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
            { path: 'dashboard', loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~dashboard-dashboard-module~profile-profile-module~qrattendance-qrattendance-module"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ../dashboard/dashboard.module */ "./src/app/dashboard/dashboard.module.ts")).then(m => m.DashboardPageModule), canActivate: [_Services_authguard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
            { path: 'conge', loadChildren: () => Promise.all(/*! import() | conge-conge-module */[__webpack_require__.e("common"), __webpack_require__.e("conge-conge-module")]).then(__webpack_require__.bind(null, /*! ../conge/conge.module */ "./src/app/conge/conge.module.ts")).then(m => m.CongePageModule), canActivate: [_Services_authguard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
            { path: 'attendance-users', loadChildren: () => Promise.all(/*! import() | attendance-users-attendance-users-module */[__webpack_require__.e("common"), __webpack_require__.e("attendance-users-attendance-users-module")]).then(__webpack_require__.bind(null, /*! ../attendance-users/attendance-users.module */ "./src/app/attendance-users/attendance-users.module.ts")).then(m => m.AttendanceUsersPageModule), canActivate: [_Services_authguard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
            { path: 'users-list', loadChildren: () => Promise.all(/*! import() | users-list-users-list-module */[__webpack_require__.e("common"), __webpack_require__.e("users-list-users-list-module")]).then(__webpack_require__.bind(null, /*! ../users-list/users-list.module */ "./src/app/users-list/users-list.module.ts")).then(m => m.UsersListPageModule), canActivate: [_Services_authguard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] }
        ]
    }
];
...
HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _home_routing_module__WEBPACK_IMPORTED_MODULE_6__["HomeRouter"]
        ],
...
/* harmony import */ var _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Settings/AppSettings */ "./src/app/Settings/AppSettings.ts");
