...
let NotificationsPage = class NotificationsPage {
    constructor(notificationService, webSocketService, modalController) {
    ...
    getNotification() {
        ...
        this.stompClient.connect({ user: _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].details.username.toString() }, function (frame) {
    ...
    deleteNotification(notification) {
        let index = this.myNotification.findIndex((obj) => obj.idNotification === notification.idNotification);
    ...
    updateNotification(notificationToUpdate) {
        ...
        this.notificationService.updateNotification(notificationToUpdate.idNotification, _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].details.id).subscribe((data) => {
            console.log(data);
        });
    }
};
