...
let AttendanceService = class AttendanceService {
    ...
    addAttendanceByQrCode(attendance) {
    ...
    setWorkTime(start, end) {
        return this.httpClient.post(_Settings_AppSettings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].ATTENDANCE_URL + '/time' + `?start=${start}&end=${end}`, {});
    }
    getWorkTime() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QrattendancePage", function() { return QrattendancePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _Entities_Attendance__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Entities/Attendance */ "./src/app/Entities/Attendance.ts");
...
let QrattendancePage = class QrattendancePage {
    constructor(modalCtrl, sharedService, attendanceService, employeeService, toastCtrl, loadingCtrl, plt) {
            ...
            if (this.videoElement.readyState === this.videoElement.HAVE_ENOUGH_DATA) {
                ...
                if (code) {
                    ...
                    this.employeeService.getEmployeeByUserId(this.currentUser.id).subscribe(data => {
                        console.log(data['0']);
                        const attendance = new _Entities_Attendance__WEBPACK_IMPORTED_MODULE_6__["Attendance"]();
                        var today = new Date();
...
QrattendancePage.ctorParameters = () => [
...
QrattendancePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-qrattendance',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./qrattendance.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/qrattendance/qrattendance.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./qrattendance.page.scss */ "./src/app/qrattendance/qrattendance.page.scss")).default]
    })
], QrattendancePage);
...
//# sourceMappingURL=default~dashboard-dashboard-module~profile-profile-module~qrattendance-qrattendance-module-es2015.js.map