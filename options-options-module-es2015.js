...
const routes = [
    {
        ...
        children: [
            ...
            { path: 'messages-list', loadChildren: () => Promise.all(/*! import() | messages-list-messages-list-module */[__webpack_require__.e("common"), __webpack_require__.e("messages-list-messages-list-module")]).then(__webpack_require__.bind(null, /*! ../messages-list/messages-list.module */ "./src/app/messages-list/messages-list.module.ts")).then(m => m.MessagesListPageModule) },
            ...
            { path: 'qr', loadChildren: () => Promise.all(/*! import() | qrattendance-qrattendance-module */[__webpack_require__.e("default~dashboard-dashboard-module~profile-profile-module~qrattendance-qrattendance-module"), __webpack_require__.e("common"), __webpack_require__.e("qrattendance-qrattendance-module")]).then(__webpack_require__.bind(null, /*! ../qrattendance/qrattendance.module */ "./src/app/qrattendance/qrattendance.module.ts")).then(m => m.QrattendancePageModule) },
            { path: 'profile', loadChildren: () => Promise.all(/*! import() | profile-profile-module */[__webpack_require__.e("default~dashboard-dashboard-module~profile-profile-module~qrattendance-qrattendance-module"), __webpack_require__.e("common"), __webpack_require__.e("profile-profile-module")]).then(__webpack_require__.bind(null, /*! ../profile/profile.module */ "./src/app/profile/profile.module.ts")).then(m => m.ProfilePageModule) },
            { path: 'holiday', loadChildren: () => Promise.all(/*! import() | conge-conge-module */[__webpack_require__.e("common"), __webpack_require__.e("conge-conge-module")]).then(__webpack_require__.bind(null, /*! ../conge/conge.module */ "./src/app/conge/conge.module.ts")).then(m => m.CongePageModule) },
        ]
    }
];
...
let OptionsPage = class OptionsPage {
    constructor(sharedService, notificationService, webSocketService) {
    ...
    getNotification() {
        let that = this;
        this.stompClient.connect({ user: _Settings_AppSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].details.username.toString() }, function (frame) {
